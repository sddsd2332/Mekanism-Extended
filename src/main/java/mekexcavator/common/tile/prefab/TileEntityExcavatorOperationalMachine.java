...
public abstract class TileEntityExcavatorOperationalMachine extends TileEntityExcavatorMachine implements IComparatorSupport {
    ...
    public TileEntityExcavatorOperationalMachine(String sound, ExcavatorMachineType type,int baseTicksRequired,int slot) {
